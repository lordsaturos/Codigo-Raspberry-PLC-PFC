...
#define BSC1_CLKT				0x2080401C /**< BSC1 Clock Stretch Timeout Register Address */
...
#define BSC_CLKT_OFFSET      0x0000001C  /**< BSC Data Delay offset from BSCx_BASE */
...
/**********************************************************************************/
/* The following are the CLKT  Register Bits                                 */
/**********************************************************************************/
#define BSC_TOUT            0x000       /**< BSC Status: Clock Stretch Timeout bit . Added to try	eliminate
										the Clock Stretch Timeout fail 0x000 disables CST*/ 
